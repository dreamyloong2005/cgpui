...
includes("build/xmake/phase_h_macos.lua")
...
includes("build/xmake/phase_h_metal.lua")
...
target("action_macro_surface_test")
    set_kind("binary")
    add_files("tests/api_parity/action_macro_surface_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui", "cgpui_app")
    add_includedirs(public_includedirs)
    add_tests("default")

target("action_macros_header_cleanliness")
    set_kind("binary")
    add_files("tests/header_cleanliness/action_macros_header_cleanliness.cpp")
    add_deps("cgpui_core")
    add_includedirs(public_includedirs)
    add_tests("default")
...
target("phase_g_runtime_task_priority_test")
    set_kind("binary")
    add_files("tests/async/runtime_task_priority_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs, "tests/ui")
    add_tests("default")

target("phase_g_runtime_task_priority_structure_test")
    set_kind("binary")
...
target("phase_g_runtime_task_cancellation_propagation_test")
    set_kind("binary")
    add_files("tests/async/runtime_task_cancellation_propagation_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs, "tests/ui")
    add_tests("default")
...
target("phase_g_runtime_task_cancellation_propagation_structure_test")
    set_kind("binary")
    add_files("tests/architecture/phase_g_runtime_task_cancellation_propagation_structure_test.cpp")
    add_tests("default", {runenvs = {CGPUI_SOURCE_ROOT = os.projectdir()}})

target("phase_g_runtime_async_io_hook_test")
    set_kind("binary")
    add_files("tests/async/runtime_async_io_hook_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs, "tests/ui")
    add_tests("default")
...
target("phase_g_animation_transition_test")
    set_kind("binary")
    add_files("tests/animation/runtime_animation_transition_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs, "tests/ui")
    add_tests("default")
...
target("phase_g_animation_transition_structure_test")
    set_kind("binary")
    add_files("tests/architecture/phase_g_animation_transition_structure_test.cpp")
    add_tests("default", {runenvs = {CGPUI_SOURCE_ROOT = os.projectdir()}})

target("phase_g_element_lifecycle_animation_test")
    set_kind("binary")
    add_files("tests/animation/element_lifecycle_animation_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs, "tests/ui")
    add_tests("default")

target("phase_g_element_lifecycle_animation_structure_test")
    set_kind("binary")
    add_files("tests/architecture/phase_g_element_lifecycle_animation_structure_test.cpp")
    add_tests("default", {runenvs = {CGPUI_SOURCE_ROOT = os.projectdir()}})

target("phase_g_element_animation_sequence_test")
    set_kind("binary")
    add_files("tests/animation/element_animation_sequence_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs, "tests/ui")
    add_tests("default")

target("phase_g_element_animation_sequence_structure_test")
    set_kind("binary")
...
target("phase_g_animation_cancellation_test")
    set_kind("binary")
    add_files("tests/animation/animation_cancellation_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs, "tests/ui")
    add_tests("default")
...
target("phase_g_animation_cancellation_structure_test")
    set_kind("binary")
    add_files("tests/architecture/phase_g_animation_cancellation_structure_test.cpp")
    add_tests("default", {runenvs = {CGPUI_SOURCE_ROOT = os.projectdir()}})

target("phase_g_animation_frame_pacing_test")
    set_kind("binary")
    add_files("tests/animation/animation_frame_pacing_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs, "tests/ui")
    add_tests("default")
...
target("phase_g_animation_frame_pacing_structure_test")
    set_kind("binary")
    add_files("tests/architecture/phase_g_animation_frame_pacing_structure_test.cpp")
    add_tests("default", {runenvs = {CGPUI_SOURCE_ROOT = os.projectdir()}})

target("phase_g_style_interpolation_test")
    set_kind("binary")
    add_files("tests/animation/style_interpolation_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs, "tests/ui")
    add_tests("default")
...
target("phase_g_png_jpeg_decode_test")
    set_kind("binary")
    add_files("tests/assets/image_decode_test.cpp")
...
target("phase_g_svg_asset_decode_test")
    set_kind("binary")
    add_files("tests/assets/svg_asset_decode_test.cpp")
    add_deps("cgpui_core", "cgpui_renderer")
    add_includedirs(public_includedirs)
    add_tests("default")
...
target("phase_g_async_asset_loading_test")
    set_kind("binary")
    add_files("tests/assets/async_asset_loading_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs, "tests/ui")
    add_tests("default")
...
target("phase_g_async_asset_loading_outcome_test")
    set_kind("binary")
    add_files("tests/assets/async_asset_loading_outcome_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs, "tests/ui")
    add_tests("default")
...
target("async_asset_loading_header_cleanliness")
    set_kind("binary")
    add_files("tests/header_cleanliness/async_asset_loading_header_cleanliness.cpp")
    add_includedirs(public_includedirs)
    add_tests("default")
...
target("phase_g_test_app_window_fixture_test")
    set_kind("binary")
    add_files("tests/ui/test_app_window_setup_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs)
    add_tests("default")

target("test_app_header_cleanliness")
    set_kind("binary")
    add_files("tests/header_cleanliness/test_app_header_cleanliness.cpp")
    add_includedirs(public_includedirs)
    add_tests("default")
...
target("phase_g_test_app_timer_control_test")
    set_kind("binary")
    add_files("tests/ui/test_app_timer_control_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs)
    add_tests("default")
...
target("phase_g_test_app_timer_control_structure_test")
    set_kind("binary")
    add_files("tests/architecture/phase_g_test_app_timer_control_structure_test.cpp")
    add_tests("default", {runenvs = {CGPUI_SOURCE_ROOT = os.projectdir()}})

target("phase_g_test_app_async_control_test")
    set_kind("binary")
    add_files("tests/ui/test_app_async_control_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui")
    add_includedirs(public_includedirs)
    add_tests("default")
...
target("phase_g_test_app_platform_services_test")
    set_kind("binary")
    add_files("tests/ui/test_app_platform_services_test.cpp")
    add_deps("cgpui_core", "cgpui_platform", "cgpui_renderer", "cgpui_ui", "cgpui_app")
    add_includedirs(public_includedirs)
    add_tests("default")
...
target("phase_g_action_macro_structure_test")
    set_kind("binary")
    add_files("tests/architecture/phase_g_action_macro_structure_test.cpp")
    add_tests("default", {runenvs = {CGPUI_SOURCE_ROOT = os.projectdir()}})

target("phase_g_test_support_closeout_test")
    set_kind("binary")
...
target("phase_g_final_closeout_test")
    set_kind("binary")
    add_files("tests/api_parity/phase_g_final_closeout_test.cpp")
    add_tests("default", {runenvs = {CGPUI_SOURCE_ROOT = os.projectdir()}})
...
target("hello_window")
    ...
    elseif is_plat("linux") then
        ...
        add_tests("x11_first_frame", {runenvs = {CGPUI_LINUX_BACKEND = "x11", CGPUI_EXIT_AFTER_FIRST_FRAME = "1"}})
        add_tests("x11_resize_after_first_frame", {runenvs = {CGPUI_LINUX_BACKEND = "x11", CGPUI_RESIZE_AFTER_FIRST_FRAME = "1"}})
        add_tests("x11_close_after_first_frame", {runenvs = {CGPUI_LINUX_BACKEND = "x11", CGPUI_CLOSE_AFTER_FIRST_FRAME = "1"}})
        add_tests("x11_demo_smoke_flow", {runenvs = {CGPUI_LINUX_BACKEND = "x11", CGPUI_DEMO_SMOKE_FLOW = "1", CGPUI_CLOSE_AFTER_FIRST_FRAME = "0"}})
    elseif is_plat("macosx") then
        add_deps("cgpui_platform_macos", "cgpui_renderer_metal")
        add_frameworks("AppKit", "QuartzCore", "Metal")
