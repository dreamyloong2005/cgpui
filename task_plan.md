...
2. [ ] Event dispatch observability: expose last event result to runtime tests and callbacks where useful.
3. [ ] Event routing shell: add a root-level dispatch function that can later route to element/view ids.
...
11. [ ] Layout pass for fixed-size leaf elements.
...
Step 2: Event dispatch observability.
