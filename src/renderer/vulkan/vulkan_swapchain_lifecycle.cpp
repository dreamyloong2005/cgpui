...
void VulkanRendererState::destroy_swapchain_resources(
  ...
  vulkan_destroy_image_pipeline_resources(device_, resources.image_pipeline);
...
void VulkanRendererState::install_swapchain(
  ...
  swapchain_image_usage_ = resources.image_usage;
  ...
  image_pipeline_resources_ = resources.image_pipeline;
