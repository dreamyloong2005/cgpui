...
| gpui accessibility | snapshot + production Win32 UIA + Linux AT-SPI D-Bus objects, navigation, roles/states, text/value/focus events, and accessibility-bus discovery/reconnect lifecycle | Required | Linux AT-SPI production closeout audit remains | Phase G |
