...
| gpui accessibility | snapshot + production Win32 UIA + Linux AT-SPI D-Bus object exposure | Required | Linux AT-SPI navigation, roles/states, events, and bus lifecycle remain | Phase G |
