...
| gpui accessibility | snapshot + production Win32 UIA + Linux AT-SPI D-Bus object exposure and tree navigation | Required | Linux AT-SPI roles/states, events, and bus lifecycle remain | Phase G |
