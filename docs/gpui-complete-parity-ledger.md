...
| gpui::div | `div()` plus repeated `.child(...)` multi-child retention, `ElementBuilder::children(...)` collection authoring, and `StyledElement::children()` child-list ownership | Adapted | `include/cgpui/ui/element_builder_core.hpp`, `include/cgpui/ui/element_style_nodes.hpp`, `src/ui/element_builder_interaction.cpp`, `src/ui/element_builder_build.cpp`, `src/ui/element_style_nodes.cpp`, `src/ui/element_style_paint.cpp`, `tests/ui/element_test.cpp` | Phase C Steps 320-324 style vocabulary |
