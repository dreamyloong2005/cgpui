...
| gpui accessibility | snapshot + production Win32 UIA + Linux AT-SPI D-Bus objects, navigation, roles/states, text/value/focus events, and accessibility-bus discovery/connection | Required | Linux AT-SPI disconnect/reconnect lifecycle remains | Phase G |
