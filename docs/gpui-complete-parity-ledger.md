...
| gpui image assets | image paint/upload pipeline, bounded file/image/GIF/SVG decode paths, stable cache keys, and thread-safe single-asset/source-wide revision invalidation | Required | Async loading and final image/GIF examples remain | Phase C/G |
