...
| gpui accessibility | snapshot + production Win32 UIA + Linux AT-SPI D-Bus objects, navigation, roles/states, and text/value events | Required | Linux AT-SPI focus events and bus lifecycle remain | Phase G |
