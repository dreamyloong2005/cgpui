...
| gpui animation | deterministic animation clock/tween plus typed scalar transitions on runtime, runtime-context, and async-context scheduling | Required | element lifecycle animation, repeat/chaining, spring variants, frame pacing, full style interpolation, and official examples remain | Phase G |
