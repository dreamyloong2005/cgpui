...
| gpui accessibility | snapshot + production Win32 UIA + Linux AT-SPI D-Bus objects, navigation, roles, and states | Required | Linux AT-SPI events and bus lifecycle remain | Phase G |
