...
| gpui accessibility | snapshot + production Win32 UIA + Linux AT-SPI D-Bus objects, navigation, roles/states, text/value events, and focus events | Required | Linux AT-SPI bus lifecycle remains | Phase G |
