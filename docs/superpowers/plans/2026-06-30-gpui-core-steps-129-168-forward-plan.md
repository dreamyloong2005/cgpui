...
- Steps 89-97 are complete on `master`; Step 98 remains the active next implementation step.
- Steps 98-128 are covered by the detailed execution plan in `docs/superpowers/plans/2026-06-30-gpui-core-steps-89-128-execution-plan.md`.
