...
- [ ] Steps 319-324: Add the upstream-style `div` element vocabulary:
  ...
  `tests/architecture/ui_source_structure_test.cpp`. Step 324 should continue
  with focused `div` shadow vocabulary/storage without broad style rewrites.
...
active feature worktree and is full-verified there. Keep the Phase B closeout
