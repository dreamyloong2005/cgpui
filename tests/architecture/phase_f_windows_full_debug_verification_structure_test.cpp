...
int main() {
  ...
  if (!contains(pointer_guard, "runtime_window_input_state.cpp") ||
      ...
      !contains(child_guard,
                "Phase H Step 679 Cocoa application and NSWindow lifecycle")) return 4;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Phase H Step 679 Cocoa application and NSWindow lifecycle\"")) return 7;
  return 0;
}
