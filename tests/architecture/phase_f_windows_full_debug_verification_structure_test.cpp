...
int main() {
  ...
  if (!contains(pointer_guard, "runtime_window_input_state.cpp") ||
      ...
      !contains(child_guard, "Phase G Step 619 Win32 UIA provider object production depth")) return 4;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Phase G Step 619 Win32 UIA provider object production depth\"")) return 7;
  return 0;
}
