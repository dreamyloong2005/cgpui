...
int main() {
  ...
  if (!contains(pointer_guard, "runtime_window_input_state.cpp") ||
      ...
      !contains(child_guard, "Step 650 official animation and opacity examples")) return 4;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 650 official animation and opacity examples\"")) return 7;
  return 0;
}
