...
int main() {
  ...
  if (!contains(pointer_guard, "runtime_window_input_state.cpp") ||
      ...
      !contains(child_guard, "Step 623 Win32 UIA focus, value, and text change integration")) return 4;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 623 Win32 UIA focus, value, and text change integration\"")) return 7;
  return 0;
}
