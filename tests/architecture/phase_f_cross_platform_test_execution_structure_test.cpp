...
int main() {
  ...
  if (!contains(wsl_guard, "Step 645 animation repeat and chaining production behavior")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 645 animation repeat and chaining production behavior\"")) return 32;
  return 0;
}
