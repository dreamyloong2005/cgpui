...
int main() {
  ...
  if (!contains(
          wsl_guard,
          "Step 671 architecture and header test matrix coverage")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 671 architecture and header test matrix coverage\"")) return 32;
  return 0;
}
