...
int main() {
  ...
  if (!contains(
          wsl_guard,
          "Step 658 official image/GIF examples and asset closeout")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 658 official image/GIF examples and asset closeout\"")) return 32;
  return 0;
}
