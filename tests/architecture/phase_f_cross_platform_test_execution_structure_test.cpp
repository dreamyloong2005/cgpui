...
int main() {
  ...
  if (!contains(wsl_guard, "Step 631 Linux AT-SPI focus event production behavior")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 631 Linux AT-SPI focus event production behavior\"")) return 32;
  return 0;
}
