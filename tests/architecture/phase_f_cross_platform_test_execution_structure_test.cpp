...
int main() {
  ...
  if (!contains(wsl_guard, "Step 646 spring and tween variant production behavior")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 646 spring and tween variant production behavior\"")) return 32;
  return 0;
}
