...
int main() {
  ...
  if (!contains(
          wsl_guard,
          "Step 659 GPUI-style app and window test setup production behavior")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 659 GPUI-style app and window test setup production behavior\"")) return 32;
  return 0;
}
