...
int main() {
  ...
  if (!contains(wsl_guard, "Step 627 Linux AT-SPI D-Bus object exposure production behavior")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 627 Linux AT-SPI D-Bus object exposure production behavior\"")) return 32;
  return 0;
}
