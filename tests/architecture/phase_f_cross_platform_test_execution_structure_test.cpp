...
int main() {
  ...
  if (!contains(wsl_guard, "Step 634 Linux AT-SPI production closeout audit")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 634 Linux AT-SPI production closeout audit\"")) return 32;
  return 0;
}
