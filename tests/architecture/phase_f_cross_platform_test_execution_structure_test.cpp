...
int main() {
  ...
  if (!contains(wsl_guard, "Step 626 Win32 UIA production closeout audit")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 626 Win32 UIA production closeout audit\"")) return 32;
  return 0;
}
