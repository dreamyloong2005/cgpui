...
int main() {
  ...
  if (!contains(wsl_guard, "Step 651 file-backed asset loading production behavior")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 651 file-backed asset loading production behavior\"")) return 32;
  return 0;
}
