...
int main() {
  ...
  if (!contains(wsl_guard, "Step 632 Linux AT-SPI accessibility bus discovery and connection production behavior")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 632 Linux AT-SPI accessibility bus discovery and connection production behavior\"")) return 32;
  return 0;
}
