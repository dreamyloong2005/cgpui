...
int main() {
  ...
  if (!contains(wsl_guard, "Step 623 Win32 UIA focus, value, and text change integration")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 623 Win32 UIA focus, value, and text change integration\"")) return 32;
  return 0;
}
