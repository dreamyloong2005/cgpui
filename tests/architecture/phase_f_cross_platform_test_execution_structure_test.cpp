...
int main() {
  ...
  if (!contains(wsl_guard, "Step 650 official animation and opacity examples")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 650 official animation and opacity examples\"")) return 32;
  return 0;
}
