...
int main() {
  ...
  if (!contains(wsl_guard, "Step 652 PNG and JPEG decode boundary production behavior")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 652 PNG and JPEG decode boundary production behavior\"")) return 32;
  return 0;
}
