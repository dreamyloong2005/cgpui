...
int main() {
  ...
  if (!contains(wsl_guard, "Step 630 Linux AT-SPI text and value event production behavior")) return 30;
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 630 Linux AT-SPI text and value event production behavior\"")) return 32;
  return 0;
}
