...
int main() {
  ...
  if (!contains(xmake,
      ...
      !contains(windows_guard, "Phase G Step 619 Win32 UIA provider object production depth")) {
    return 20;
  }
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Phase G Step 619 Win32 UIA provider object production depth\"")) return 22;
  return 0;
}
