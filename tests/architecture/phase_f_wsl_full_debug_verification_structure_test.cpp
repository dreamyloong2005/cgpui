...
int main() {
  ...
  if (!contains(xmake,
      ...
      !contains(windows_guard, "Step 620 Win32 UIA tree navigation production behavior")) {
    return 20;
  }
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 621 Win32 UIA pattern provider production behavior\"")) return 22;
  return 0;
}
