...
int main() {
  ...
  if (!contains(xmake,
      ...
      !contains(windows_guard, "Step 623 Win32 UIA focus, value, and text change integration")) {
    return 20;
  }
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 623 Win32 UIA focus, value, and text change integration\"")) return 22;
  return 0;
}
