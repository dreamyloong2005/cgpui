...
int main() {
  ...
  if (!contains(xmake,
      ...
      !contains(windows_guard,
                "Step 665 GPUI-style test runner ergonomics production behavior")) {
    return 20;
  }
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 665 GPUI-style test runner ergonomics production behavior\"")) return 22;
  return 0;
}
