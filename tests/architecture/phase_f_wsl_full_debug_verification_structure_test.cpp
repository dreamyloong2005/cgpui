...
int main() {
  ...
  if (!contains(xmake,
      ...
      !contains(windows_guard, "Step 650 official animation and opacity examples")) {
    return 20;
  }
  ...
  if (!contains(ledger_json,
                "\"phase_f_current_handoff\": \"Step 650 official animation and opacity examples\"")) return 22;
  return 0;
}
