...
int main() {
  const std::string example =
      read_source("examples/api_parity/public_text_wrapper_examples/main.cpp");
  ...
  constexpr std::array required_example_fragments{
      ...
      "class PublicTextWrapperExamplesView",
      "cgpui::IntoElement render(",
      "cgpui::Context<PublicTextWrapperExamplesView>&",
      "static_assert(cgpui::Render<PublicTextWrapperExamplesView>)",
      "cgpui::label(",
      "cgpui::TextElement",
      "cgpui::TextModel",
      "cgpui::measure_text(",
      "cgpui::wrap_text_measurement(",
      "cgpui::text_glyph_paint_metadata(",
      "cgpui::TextWrapLayout",
      "cgpui::TextWrapLine",
      "cgpui::TextWrapBreakKind",
      "cgpui::TextMeasurementCache",
      "cgpui::TextMeasurementResult",
      "cgpui::LayoutInput",
      "accessibility_text()",
      "CGPUI_RUN_PUBLIC_TEXT_WRAPPER_EXAMPLES",
  };
  ...
  constexpr std::array required_docs{
      "Phase D Step 444 text wrapper public examples",
      "examples/api_parity/public_text_wrapper_examples/main.cpp",
      "api_parity_public_text_wrapper_examples",
      "phase_d_text_wrapper_public_examples_test.cpp",
      "Step 444 extends the text-input examples band",
      "label and TextElement wrappers",
      "measurement/wrapping/glyph paint metadata",
  };
  ...
  if (!contains(ledger_json,
                "\"step_444\": \"Phase D Step 444 text wrapper public examples\"")) {
    return 80;
  }
